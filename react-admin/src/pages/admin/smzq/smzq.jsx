...
注意：只要使用了constructor()就必须写super(),否则会导致this指向错误。</p>
                ...
                <p className="f16">render组件更新时调用</p>
                ...
                <h3 className="f20">4 其他</h3>
                <p className="f18">componentWillUnmount </p>
                <p className="f16">在子组件发生删除dom的时候触发（删除一个元素就可以触发），添加和发生改变则不会</p>
            </div>
        )
    }
